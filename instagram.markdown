...
As you can imagine, instagram-scraper can be quite useful if you are interested in building an archive of Instagram data, which could include posts, comments, geolocation, and numerous metadata that cannot easily be scraped via Instagram’s user interface. However, while instagram-scraper can retrieve almost anything from Instagram it is important to read Instagram's [Terms of Use](Source: https://help.instagram.com/581066165581870). Specifically, the Terms of Use state, "You can't attempt to create accounts or access or collect information in unauthorized ways. This includes creating accounts or collecting information in an automated way without our express permission." As such, the instagram-scraper along with any automated tools should be used with caution when gathering Instagram data for research purposes.
