...
Here is a [download link](files/scilit2020.jsonl) to an jsonl file example of a twarc filter search for tweets on Science Literacy Week in 2020 (#scilit). You can open and view the file with a text editor, such as [BBEdit](https://apps.apple.com/us/app/bbedit/id404009241?mt=12) on OSX or [notepad++](https://notepad-plus-plus.org/downloads/) on Windows.
