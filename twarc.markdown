...
Here is a [download link](files/scilit2020.jsonl) to an example jsonl file of a twarc filter result for tweets gathered on the topic of Science Literacy Week from September 22-29, 2020. You can open and view the file with a text editor, such as [BBEdit](https://apps.apple.com/us/app/bbedit/id404009241?mt=12) on OSX or [notepad++](https://notepad-plus-plus.org/downloads/) on Windows.
